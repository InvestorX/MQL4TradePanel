...
input ushort   ServerPort = 4545;        // Server port
...
void OnTick()
{
   ...
   if (glbClientSocket.IsSocketConnected()) {
      ...
      string strMsg = Symbol() + "," + DoubleToString(SymbolInfoDouble(Symbol(), SYMBOL_BID), 6) + "," + DoubleToString(SymbolInfoDouble(Symbol(), SYMBOL_ASK), 6)+"""<EOF>""" ;
